...
-- Increment/decrement
map("n", "+", "<cmd>DialIncrement<CR>")
map("n", "-", "<cmd>DialDecrement<CR>")
...
map("n", "<Left>", ":KittyNavigateLeft<cr>")
map("n", "<Down>", ":KittyNavigateDown<cr>")
map("n", "<Up>", ":KittyNavigateUp<cr>")
map("n", "<Right>", ":KittyNavigateRight<cr>")
map("n", "<C-x>", "<C-W>p")
