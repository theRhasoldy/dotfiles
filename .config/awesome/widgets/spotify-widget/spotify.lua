...
local function worker(user_args)
    ...
    local play_icon = args.play_icon or "/home/rhasoldy/.config/awesome/icons/wibar/play.svg"
    local pause_icon = args.pause_icon or "/home/rhasoldy/.config/awesome/icons/wibar/pause.svg"
    ...
    if show_tooltip then
        ...
        spotify_widget:connect_signal('mouse::enter', function()
            spotify_tooltip.markup = '<b>Song</b>: ' .. cur_title
                .. '\n<b>Album</b>: ' .. cur_album
