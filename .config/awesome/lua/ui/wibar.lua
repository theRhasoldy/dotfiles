...
awful.screen.connect_for_each_screen(function(s)
	...
	-- Create the wibox
	s.mywibox =
		awful.wibar({ bg = "#00000000", height = space * 1.6, border_width = 0, position = "bottom", screen = s })
		...
		margins = space / 2,
		{
			...
			{ -- Right widgets
				...
				},
				{
					layout = wibox.layout.fixed.horizontal,
					spacing = space / 2,
					create_icon("󰫅", theme.icon_color_1),
					uptime_text,
				},
				{
					layout = wibox.layout.fixed.horizontal,
					spacing = space / 2,
					create_icon("󱓻", theme.icon_color_2),
					date,
				},
				{
					layout = wibox.layout.fixed.horizontal,
					spacing = space / 2,
					create_icon("󰞌", theme.icon_color_3),
					time,
				},
			},
		},
